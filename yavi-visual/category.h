...
public:
    ...
    void           widget_stretch( int width, int height, bool add = true ) noexcept;         // растягиваем виджет
...
private:
    ...
    void           widget_parent_stretch( int width, int height, bool add = true ) noexcept;  // растягиваем виджет
